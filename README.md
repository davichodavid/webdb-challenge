...
An RDBMS is a system used to manipulate data. SQL is the query language utilized when working with an RDMS.

2. Why do tables need a `primary key`?

It helps identify a current set of data. It prevents anomalies.

3. What is the name given to a table column that references the primary key on another table.

It is called a Relationship/foreign key.

4. What do we need in order to have a _many to many_ relationship between two tables.

Both tables must have relationships with other tables beside each other.
